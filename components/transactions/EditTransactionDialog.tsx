...
export function EditTransactionDialog({ transaction, open, onOpenChange, categories, wallets }: EditTransactionDialogProps) {
  ...
  useEffect(() => {
    if (transaction) {
      const category = categories.find(c => c.name === transaction.category?.name)
